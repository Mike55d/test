...
class DFlip_Meta_boxes {
  ...
  public function add_meta_boxes() {
    add_meta_box( 'dflip_post_meta_box_support_us', __( 'Support Us!', 'DFLIP' ), array( $this, 'create_meta_boxes_support_us' ), 'dflip', 'normal', 'low' );
  ...
  public function create_meta_boxes_support_us( $post ) {
    ?>
    <div class="dflip-notice lite-limits" style="padding:15px 10px;line-height: 1.7em;">
      Thank you for using our little flipbook plugin :) We hope it has been useful for you and keeps helping you with your cause.
      <br>We love improving our plugin and keep updating it. <strong>You too can <a href="https://wordpress.org/support/plugin/3d-flipbook-dflip-lite/reviews/?filter=5#new-post" target="_blank">SHARE SOME <span
                  style="color:#ffa000; font-size:1.2em;">&#9733;&#9733;&#9733;&#9733;&#9733;</span> SUPPORT</a> on WordPress.org!</strong> It would mean a lot to us!

      <hr style="margin:20px 0">

      <div style="opacity: 0.9;font-size:0.95em;line-height: 1.5em;">
        If you like, we have some more features in our premium version.
        ...
        <ol>
          ...
          <li> PDF links, translate, analytics, custom share prefix, zoom settings, controls customization, etc.</li>
          <li> Popup lightboxes for button and custom types</li>
          <li> And more...</li>
        </ol>
        <a href="https://dearflip.com/go/wp-lite-vs-premium" target="_blank">See Full Comparision</a> | <a href="https://dearflip.com/go/wp-lite-full-version" target="_blank">
          Get Full Version</a>
      </div>
    </div>
  ...
  public function create_meta_boxes_video( $post ) {
    ...
    if ( $current_screen->post_type == 'dflip' ) {
      ...
      <ul>
        <li>
          <a class="video-tutorial" href="https://dearflip.com/go/wp-lite-video-tutorial" target="_blank"><span class="dashicons dashicons-video-alt3"></span>See Video Tutorial</a>
        </li>
        <li>
          <a class="video-tutorial" href="
      https://dearflip.com/go/wp-lite-docs" target="_blank"><span class="dashicons dashicons-book"></span>Live Documentation</a>
        </li>
        <li>
          <a class="video-tutorial" href="https://wordpress.org/support/plugin/3d-flipbook-dflip-lite/" target="_blank"><span class="dashicons dashicons-format-chat"></span>Any Issues? Share with us!</a>
        </li>
        <!--        <li>-->
