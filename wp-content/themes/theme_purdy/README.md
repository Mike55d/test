...
1.Go to theme.
2.Install sage directives : composer require log1x/sage-directives
2.Config the devUrl and proxyUrl in : [theme_name]/resources/assets/config.json
3.Install modules in the theme directory : yarn
4.Run webpack watcher : yarn start

For more information go to : https://roots.io/sage/docs/theme-installation/

## Generate assets for production

Run the commant: yarn build:production

## Wordpress Plugins 

ACF PRO
Api Key : b3JkZXJfaWQ9MTM3ODc5fHR5cGU9ZGV2ZWxvcGVyfGRhdGU9MjAxOC0wOC0yMyAyMToxNToxMQ==


## Config Post types
The condfiguration of post types and custome fields are on code.
/wp-content/themes/[theme_name]/resources/post-types/


Use ACF PRO for generarte the code php used for config the post type.
Go to CMS 
